...
public class FileRenameCommand_CommandLineReceived_ExcpectedResult
{
    [Theory]
    [InlineData("file rename C:\\Users\\dimab\\Downloads\\test.txt dimon_limon", ResultTypeForRetrieving.Success)]
    public void TestCase(string requestLine, ResultTypeForRetrieving resultType)
    {
        var connectCommandParser = new FileRenameParser();
