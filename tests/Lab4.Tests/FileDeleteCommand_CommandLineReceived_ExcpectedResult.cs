...
public class FileDeleteCommand_CommandLineReceived_ExcpectedResult
{
    [Theory]
    [InlineData("delete C:\\Users\\dimab\\Downloads", ResultTypeForRetrieving.Success)]
    public void TestCase(string requestLine, ResultTypeForRetrieving resultType)
    {
        var connectCommandParser = new DeleteParser();
